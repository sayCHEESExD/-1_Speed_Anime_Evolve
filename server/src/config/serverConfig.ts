...
import { DEFAULT_BLOXITY_GAME_SLUG, DEFAULT_SERVER_PORT, SERVER_TICK_RATE } from '@anime/shared';
...
export interface ServerConfig {
  ...
  /**
   * Directory holding the JSON dev store (`profiles.json`),
...
export const serverConfig: ServerConfig = {
  ...
  dataDir: resolve(process.env['ANIME_DATA_DIR'] ?? 'data'),
