...
export class BloxityAvatar {
  ...
  private applyProportions(p: LegionProportions): void {
    ...
    // Height scales the whole avatar, from the feet up (the group sits at the feet).
     ...
     * overwrote the enlargement a runner needs to be recognisable from the
    ...
    // `legOffsetX` moves the legs apart rather than scaling them - a wider
    // or narrower stance, as the portal's customiser shows it.
