 ...
 */
/** The portal's own default portrait, for a player who has not picked one. */
export const DEFAULT_PORTRAIT = 'https://static.bloxity.io/img/pfps/0.png?width=128&quality=85';
 ...
 *
 * Shared so a face is the same shape over a runner as it is on a board, and so
